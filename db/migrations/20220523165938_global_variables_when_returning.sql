...
CREATE TABLE `global_variables_when_returning` (
  ...
  CONSTRAINT `global_variables_when_returning_fk_2` FOREIGN KEY (`node_id`, `global_variable_name`) REFERENCES `global_variables_when_returning` (`node_id`, `global_variable_name`)
